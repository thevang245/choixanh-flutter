...
class ProfilePage extends StatefulWidget {
  ...
  const ProfilePage({super.key,required this.onTapCartHistory});
        ...
        child: Column(
          children: [
                                    ...
                                    buttonProfile(
                                        ...
                                        onPressed: () {
                                          Navigator.push(
                                            ...
                                            // Khi quay lại tự động reload lại trạng thái
                                            loadLoginStatus();
                                          });
                                        }),
                                    SizedBox(width: 8),
            ...
            SettingItemCard(
              ...
              title: 'Đăng xuất',
              onTap: () async {
                final authService = await AuthService.handleLogout(context);
              },
            ),
          ],
        ),
